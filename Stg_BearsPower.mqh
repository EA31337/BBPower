...
INPUT int BearsPower_SignalOpenFilterTime = 10;    // Signal filter time
...
INPUT int BearsPower_TickFilterMethod = -48;       // Tick filter method
...
INPUT float BearsPower_OrderCloseLoss = 0;         // Order close loss
